...
{
    // This is an action filter class
    // Action filters intercept the request and response data and you could modify
    // the data before it reaches controllers or to the data generated by controller 
